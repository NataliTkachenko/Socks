      ...
      <div className="container-fluid">
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item" style={glav}>
              <img className="icons" src="/Img/map.png" alt="map" />
              {' '}
              г. Москва, Шоссе Энтузиастов 12 ст2
            </li>
            <li className="nav-item" style={glav}>
              <img className="icons" src="/Img/phone.png" alt="map" />
              {' '}
              +7 999 666 36 36
            </li>
            <li className="m-2">
              <div
                className="socials"
                style={{
                  display: 'flex', alignItems: 'center', columnGap: '20px', marginRight: '100px',
                }}
              >
